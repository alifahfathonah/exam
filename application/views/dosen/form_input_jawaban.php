...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <strong class="text-light"> Form Input Jawaban </strong>
        </div>
        <div class="card-body">
            <?php echo $this->session->flashdata('message'); ?>
            <form method="post" action="<?= base_url('dosen/add_jawaban'); ?>">
                ...
                <div class="form-group row">
                    <label for="Jawaban" class="col-sm-2 col-form-label"><strong>Jawaban</strong></label>
                    <div class="col-sm-10">
                        <select name="" id="Jawaban" class="form-control" onchange="getJawaban();">
                            <option value="">+ Tambah Jawaban</option>
                            <?php
                            foreach ($jawaban->result() as $j) {
                                echo "<option value='$j->id_jawaban'>$j->jawaban</option>";
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="jawaban" id="rincianJawaban" rows="10" placeholder="Inputkan jawaban" required></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nilaiJawaban" class="col-sm-2 col-form-label"><strong>Nilai Jawaban</strong></label>
                    <div class="col-sm-10">
                        <select name="nilai_jawaban" id="nilaiJawaban" class="form-control" required>
                ...
                <button type="submit" class="btn btn-dark">Tambah Jawaban <i class="fa fa-plus"></i></button>
            </form>
        </div>
    </div>
